...
|2              |[Исследование надежности заемщиков]([Analysis of bank data](https://github.com/MarinaFilobok/Portfolio/tree/207f2e5fcceef55cd3175df98ac120d11ab98951/Analysis%20of%20bank%20data))|Разбираемся, влияет ли семейное положение и количество детей клиента на факт погашения кредита в срок. Анализируем данные о клиентах банка и определяем долю кредитоспособных|`предобработка данных` `Python` `Pandas`|
